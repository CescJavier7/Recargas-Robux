...
// 2. Creamos un componente interno para la lógica del Login
    ...
    >
      <div className="relative p-[2px] rounded-[2rem] overflow-hidden bg-slate-200 dark:bg-slate-800">
        <motion.div 
          ...
          className="absolute inset-[-100%] bg-[conic-gradient(from_0deg,#00f0ff,#ff003c,#00f0ff)] opacity-30"
        />
        ...
        <div className="relative bg-white dark:bg-dark-900 rounded-[1.9rem] p-8 md:p-10 shadow-2xl">
          ...
          <div className="space-y-6">
            <p className="text-slate-500 dark:text-slate-400 text-xs font-mono text-center leading-relaxed">
              [ SISTEMA DE AUTENTICACIÓN NEXUS ]<br/>
              VERIFICACIÓN DE IDENTIDAD REQUERIDA
            </p>

            <button
              onClick={handleLogin}
              className="w-full group relative flex items-center justify-between bg-slate-900 dark:bg-white text-white dark:text-slate-900 py-4 px-5 rounded-2xl font-display font-bold uppercase tracking-widest transition-all hover:ring-4 hover:ring-neon-cyan/20 active:scale-95 shadow-lg overflow-hidden"
            >
          ...
          <div className="mt-10 pt-6 border-t border-slate-100 dark:border-slate-800">
            <div className="flex items-center justify-center gap-6 text-[10px] font-mono text-slate-400 dark:text-slate-500 uppercase tracking-widest">
...
// 3. El componente principal ahora solo envuelve el contenido en Suspense
export default function LoginPage() {
  return (
    <main className="min-h-[calc(100vh-64px)] flex items-center justify-center p-6 relative overflow-hidden bg-slate-50 dark:bg-slate-950">
      ...
      <Suspense fallback={<div className="text-neon-cyan font-mono animate-pulse">Cargando Terminal...</div>}>
        <LoginContent />
      </Suspense>
    </main>
  );
